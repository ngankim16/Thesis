...
<head>
        ...
        <link rel="stylesheet" href="{{asset('./back-end/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css')}}">
        <link rel="stylesheet"
                href="{{asset('./back-end/plugins/datatables-responsive/css/responsive.bootstrap4.min.css')}}">
        <link rel="stylesheet" href="{{asset('./back-end/plugins/datatables-buttons/css/buttons.bootstrap4.min.css')}}">
        ...
        <link rel="stylesheet" href="{{asset('./back-end/plugins/sweetalert2-theme-bootstrap-4/bootstrap-4.min.css')}}">
                        ...
                        <div class="sidebar pb-4 mb-4">
                                <nav class="mt-4">
                                        <ul class="nav nav-pills nav-sidebar flex-column nav-flat"
                                                ...
                                                <li class="nav-item">
                                                        <a href="{{URL::to('/dashboard_sinh_vien')}}"
                                                ...
                                                <li class="nav-item">
                                                        <a href="{{route('sinhvien.list_lbv')}}"
                                                                class="nav-link nav-track">
                                                                <i class="nav-icon fa fa-chalkboard-teacher"></i>
                                                                <p>Lịch Bảo Vệ</p>
                                                        </a>
